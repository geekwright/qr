...
if(!defined('_MI_QR_NAME')) { // if modinfo isn't loaded, do it
...
function adminmenu($currentoption=0, $breadcrumb = "")
{
  ...
  $return .= "<div id='admintop'>";
    ...
    $return .= "<td style='width: 60%; font-size: 10px; text-align: left; color: #2F5376; padding: 0 6px; line-height: 18px;'><a href='" . XOOPS_URL . "/modules/system/admin.php?fct=preferences&amp;op=showmod&amp;mod=" . $xoopsModule->getVar('mid') . "'>" . _AM_QRMODULE_ADMENU_PREF . "</a> | <a href='" . XOOPS_URL . "/modules/" . $xoopsModule->getVar('dirname') . "/index.php'>" . _AM_QRMODULE_ADMENU_GOMOD . '</a> | <a href="help.php">'._AM_QRMODULE_ADMENU_HELP.'</a></td>';
...
if (defined("ICMS_ROOT_PATH")) icms_cp_header();
else xoops_cp_header();
